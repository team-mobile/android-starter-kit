...
import starter.kit.rx.app.feature.crop.AICropActivity;
...
public class MainActivity extends StarterActivity implements Drawer.OnDrawerItemClickListener {
  ...
  private void setupDrawer(Bundle savedInstanceState) {
    ...
    result = new DrawerBuilder().withActivity(this)
        ...
        .addDrawerItems(
            ...
            new PrimaryDrawerItem().withName("AICrop").withIcon(FontAwesome.Icon.faw_adjust).withTag(TAG_IMAGE_CROP)
        )
  ...
  @Override public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
    ...
    if (TAG_IMAGE_CROP.equals(drawerItem.getTag())) {
      startActivity(new Intent(MainActivity.this, AICropActivity.class));
      return true;
    }
    return false;
  }
