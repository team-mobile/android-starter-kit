...
import static starter.kit.rx.app.model.config.Constant.JX_API_PLATFORM;
import static starter.kit.rx.app.model.config.Constant.JX_AUTH_API_ROLE_PARENTS;
...
public class AuthPresenter extends NetworkPresenter<User, LoginActivity> {
    ...
    public Observable<User> request() {
        return mAuthService.login(username, password, JX_AUTH_API_ROLE_PARENTS, JX_API_PLATFORM);
    }
